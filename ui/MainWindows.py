...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(10, 0, 881, 461))
        ...
        self.quit.setMinimumSize(QtCore.QSize(50, 0))
        self.quit.setMaximumSize(QtCore.QSize(130, 16777215))
        self.quit.setBaseSize(QtCore.QSize(50, 50))
        self.quit.setObjectName("quit")
        self.verticalLayout_2.addWidget(self.quit)
        self.horizontalLayout.addLayout(self.verticalLayout_2)
        self.mainui = QtWidgets.QHBoxLayout()
        self.mainui.setSizeConstraint(QtWidgets.QLayout.SetNoConstraint)
